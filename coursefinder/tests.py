...
class CourseFinderModelsTests(UniSimpleTestCase):
    ...
    def test_course_search_execute_function_appends_counts_and_list_of_courses_to_model_on_success(self):
        ...
        self.assertEqual(course_search.total_courses, mock_data.get('total_number_of_courses'))
        self.assertEqual(course_search.total_institutions, mock_data.get('total_results'))
        self.assertEqual(type(course_search.results), list)
        self.assertEqual(len(course_search.results), len(mock_data.get('items')))
    ...
    def test_course_finder_choose_country_next_page_returns_mode_of_study_sibling(self):
        ...
        self.assertEqual(type(country_finder.next_page), CourseFinderModeOfStudy)
    ...
    def test_course_finder_choose_country_back_page_returns_parent_page(self):
        ...
        self.assertEqual(type(country_finder.back_page), SearchLandingPage)
    ...
    def test_course_finder_mode_of_study_next_page_returns_choose_subject_sibling(self):
        ...
        self.assertEqual(type(mode_of_study.next_page), CourseFinderChooseSubject)
    ...
    def test_course_finder_mode_of_study_back_page_returns_choose_country_sibling(self):
        ...
        self.assertEqual(type(mode_of_study.back_page), CourseFinderChooseCountry)
    ...
    def test_course_finder_choose_subject_next_page_returns_narrow_search_sibling(self):
        ...
        self.assertEqual(type(choose_subject.next_page), CourseFinderNarrowSearch)
    ...
    def test_course_finder_choose_subject_back_page_returns_mode_of_study_sibling(self):
        ...
        self.assertEqual(type(choose_subject.back_page), CourseFinderModeOfStudy)
    ...
    def test_course_finder_narrow_search_back_page_returns_choose_subject_sibling(self):
        ...
        self.assertEqual(type(narrow_search.back_page), CourseFinderChooseSubject)
    ...
    def test_course_finder_uni_next_page_returns_summary_sibling(self):
        ...
        self.assertEqual(type(uni.next_page), CourseFinderSummary)
    ...
    def test_course_finder_uni_back_page_returns_narrow_search_sibling(self):
        ...
        self.assertEqual(type(uni.back_page), CourseFinderNarrowSearch)
    ...
    def test_course_finder_postcode_next_page_returns_summary_sibling(self):
        ...
        self.assertEqual(type(postcode.next_page), CourseFinderSummary)
    ...
    def test_course_finder_postcode_back_page_returns_narrow_search_sibling(self):
        ...
        self.assertEqual(type(postcode.back_page), CourseFinderNarrowSearch)
    ...
    def test_course_finder_summary_next_page_returns_results_sibling(self):
        ...
        self.assertEqual(type(summary.next_page), CourseFinderResults)
    ...
    def test_course_finder_summary_back_page_returns_narrow_search_sibling(self):
        ...
        self.assertEqual(type(summary.back_page), CourseFinderNarrowSearch)
    ...
    def test_course_finder_search_execute_function_appends_counts_and_list_of_courses_to_model_on_success(self):
        ...
        self.assertIsNone(error)
        self.assertEqual(course_finder_search.total_courses, mock_data.get('total_number_of_courses'))
        self.assertEqual(course_finder_search.total_institutions, mock_data.get('total_results'))
        self.assertEqual(type(course_finder_search.results), list)
        self.assertEqual(len(course_finder_search.results), len(mock_data.get('items')))
...
class CourseFinderUtilsTests(UniSimpleTestCase):
    def test_choose_country_sibling_finder_returns_country_finder_if_in_list(self):
        ...
        self.assertEqual(type(output), CourseFinderChooseCountry)
    ...
    def test_choose_country_sibling_finder_returns_first_entry_if_multiple_country_finders_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderChooseCountry)
        self.assertNotEqual(country_finder_1.title, country_finder_2.title)
        self.assertEqual(output.title, country_finder_1.title)
    ...
    def test_choose_country_sibling_finder_returns_country_finder_if_multiple_page_types_exists(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderChooseCountry)
        self.assertNotEqual(country_finder.title, mode_of_study_finder.title)
        self.assertEqual(output.title, country_finder.title)
    ...
    def test_mode_of_study_sibling_finder_returns_mode_of_study_if_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderModeOfStudy)
    ...
    def test_mode_of_study_sibling_finder_returns_first_entry_if_multiple_mode_of_study_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderModeOfStudy)
        self.assertNotEqual(mode_of_study_finder_1.title, mode_of_study_finder_2.title)
        self.assertEqual(output.title, mode_of_study_finder_1.title)
    ...
    def test_mode_of_study_sibling_finder_returns_mode_of_study_if_multiple_page_types_exists(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderModeOfStudy)
        self.assertNotEqual(mode_of_study_finder.title, subject_chooser.title)
        self.assertEqual(output.title, mode_of_study_finder.title)
    ...
    def test_choose_subject_sibling_finder_returns_choose_subject_if_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderChooseSubject)
    ...
    def test_choose_subject_sibling_finder_returns_first_entry_if_multiple_choose_subject_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderChooseSubject)
        self.assertNotEqual(subject_chooser_1.title, subject_chooser_2.title)
        self.assertEqual(output.title, subject_chooser_1.title)
    ...
    def test_choose_subject_sibling_finder_returns_choose_subject_if_multiple_page_types_exists(self):
        ...
        self.assertEqual(type(output), CourseFinderChooseSubject)
        self.assertNotEqual(mode_of_study_finder.title, subject_chooser.title)
        self.assertEqual(output.title, subject_chooser.title)
    ...
    def test_narrow_search_sibling_finder_returns_narrow_search_if_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderNarrowSearch)
    ...
    def test_narrow_search_sibling_finder_returns_first_entry_if_multiple_narrow_search_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderNarrowSearch)
        self.assertNotEqual(narrow_search_1.title, narrow_search_2.title)
        self.assertEqual(output.title, narrow_search_1.title)
    ...
    def test_narrow_search_sibling_finder_returns_narrow_search_if_multiple_page_types_exists(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderNarrowSearch)
        self.assertNotEqual(mode_of_study_finder.title, narrow_search.title)
        self.assertEqual(output.title, narrow_search.title)
    ...
    def test_postcode_sibling_finder_returns_postcode_if_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderPostcode)
    ...
    def test_postcode_sibling_finder_returns_first_entry_if_multiple_postcode_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderPostcode)
        self.assertNotEqual(postcode_1.title, postcode_2.title)
        self.assertEqual(output.title, postcode_1.title)
    ...
    def test_postcode_sibling_finder_returns_postcode_if_multiple_page_types_exists(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderPostcode)
        self.assertNotEqual(mode_of_study_finder.title, postcode.title)
        self.assertEqual(output.title, postcode.title)
    ...
    def test_summary_sibling_finder_returns_summary_if_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderSummary)
    ...
    def test_summary_sibling_finder_returns_first_entry_if_multiple_summary_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderSummary)
        self.assertNotEqual(summary_1.title, summary_2.title)
        self.assertEqual(output.title, summary_1.title)
    ...
    def test_summary_sibling_finder_returns_summary_if_multiple_page_types_exists(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderSummary)
        self.assertNotEqual(mode_of_study_finder.title, summary.title)
        self.assertEqual(output.title, summary.title)
    ...
    def test_results_sibling_finder_returns_results_if_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderResults)
    ...
    def test_results_sibling_finder_returns_first_entry_if_multiple_results_in_list(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderResults)
        self.assertNotEqual(results_1.title, results_2.title)
        self.assertEqual(output.title, results_1.title)
    ...
    def test_results_sibling_finder_returns_results_if_multiple_page_types_exists(self):
        ...
        self.assertIsNotNone(output)
        self.assertEqual(type(output), CourseFinderResults)
        self.assertNotEqual(mode_of_study_finder.title, results.title)
        self.assertEqual(output.title, results.title)
