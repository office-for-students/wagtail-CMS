...
class SatisfactionStatistics:
    ...
    def __init__(self, data_obj, language):
        ...
        self.t1 = SatisfactionQuestion(data_obj.get('t1'))
        self.t2 = SatisfactionQuestion(data_obj.get('t2'))
        self.t3 = SatisfactionQuestion(data_obj.get('t3'))
        self.t4 = SatisfactionQuestion(data_obj.get('t4'))
        self.t5 = SatisfactionQuestion(data_obj.get('t5'))
        self.t6 = SatisfactionQuestion(data_obj.get('t6'))
        self.t7 = SatisfactionQuestion(data_obj.get('t7'))
